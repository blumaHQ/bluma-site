...
export const ui = {
  ...
  pt: {
    ...
    'faq.a4': 'São estimativas calculadas no dispositivo a partir do seu histórico de ciclo registrado (sem nuvem). Se seu ciclo for regular e você registrar consistentemente, as previsões podem ser bem próximas; se seu ciclo variar bastante, elas serão menos precisas e vão atualizar conforme novos dados forem adicionados.',
  ...
  es: {
    ...
    'features.symptoms.desc': 'Rastrea síntomas, estados de ánimo, flujo, flujo vaginal y otros marcadores de salud para identificar patrones con el tiempo y entender qué te está diciendo tu cuerpo.',
    ...
    'features.reminders.desc': 'Recibe recordatorios suaves antes de tu periodo, ovulación y ventana fértil.',
    ...
    'benefits.ondevice.desc': 'Las apps de privacidad no tienen que ser complicadas. Bluma está diseñada para ser tan fácil y agradable de usar como privada, sin el ruido de anuncios y ventas.',
    ...
    'faq.a4': 'Son estimaciones calculadas en el dispositivo a partir de tu historial de ciclo registrado (sin nube). Si tu ciclo es regular y registras de forma constante, las predicciones pueden ser bastante precisas; si tu ciclo varía mucho, serán menos precisas y se actualizarán a medida que se añadan nuevos datos.',
